...
var form = document.querySelector("form"),
    ...
    dateinput = dateField.querySelector(".date"); //Name Validation

function validName() {
  var namPattern = /^[a-zA-z\.\-_Jr., Sr., II III]{1,30}$/;
...
var eyeIcons = form.querySelectorAll(".show-hide");
...
form.addEventListener("submit", function (e) {
  ...
  if (!emailField.classList.contains("invalid") && !namField.classList.contains("invalid") && !passField.classList.contains("invalid") && !dateField.classList.contains("invalid") && !phoneField.classList.contains("invalid") && !cPassField.classList.contains("invalid")) {
